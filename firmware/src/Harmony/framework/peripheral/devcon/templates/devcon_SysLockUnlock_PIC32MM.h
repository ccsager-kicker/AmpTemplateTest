...
#ifndef _DEVCON_SYSLOCKUNLOCK_PIC32MM_H
#define _DEVCON_SYSLOCKUNLOCK_PIC32MM_H
...
PLIB_TEMPLATE void DEVCON_SystemUnlock_PIC32MM( DEVCON_MODULE_ID index )
{	
	SYSKEY = 0x00000000;
	SYSKEY = 0xAA996655;
	SYSKEY = 0x556699AA;
...
PLIB_TEMPLATE void DEVCON_SystemLock_PIC32MM( DEVCON_MODULE_ID index )
{
	SYSKEY = 0x00000000;
}
...
PLIB_TEMPLATE bool DEVCON_ExistsSystemLockUnlock_PIC32MM( DEVCON_MODULE_ID index )
{
    return true;
}
