...
typedef enum {
    OSC_SYSPLL_OUT_MULT_24 = 0x06,
    OSC_SYSPLL_OUT_MULT_12 = 0x05,
    OSC_SYSPLL_OUT_MULT_8 = 0x04,
    OSC_SYSPLL_OUT_MULT_6 = 0x03,
    OSC_SYSPLL_OUT_MULT_4 = 0x02,
    OSC_SYSPLL_OUT_MULT_3 = 0x01,
    OSC_SYSPLL_OUT_MULT_2 = 0x00
} OSC_SYSPLL_OUT_MULT;
...
{
     return OSC_ExistsPBClockDivisor_Unsupported(index);
}
...
{
     return OSC_PBClockDivisorGet_Unsupported(index, peripheralBusNumber);
}
...
{
     OSC_PBClockDivisorSet_Unsupported(index, peripheralBusNumber, peripheralBusClkDiv);
}
