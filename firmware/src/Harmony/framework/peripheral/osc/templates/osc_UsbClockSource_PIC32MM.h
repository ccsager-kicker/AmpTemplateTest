...
#ifndef _OSC_USBCLOCKSOURCE_PIC32MM_H
#define _OSC_USBCLOCKSOURCE_PIC32MM_H
...
PLIB_TEMPLATE bool OSC_ExistsUsbClockSource_PIC32MM( OSC_MODULE_ID index )
{
    return true;
}
...
PLIB_TEMPLATE void OSC_UsbClockSourceSelect_PIC32MM( OSC_MODULE_ID index , OSC_USBCLOCK_SOURCE usbClock )
{
	SPLLCONbits.PLLMULT = usbClock;
}
...
PLIB_TEMPLATE OSC_USBCLOCK_SOURCE OSC_UsbClockSourceGet_PIC32MM( OSC_MODULE_ID index )
{
    return (OSC_USBCLOCK_SOURCE)SPLLCONbits.PLLMULT;
}
