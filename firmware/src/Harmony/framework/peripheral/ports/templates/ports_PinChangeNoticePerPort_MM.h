...
#ifndef _PORTS_PINCHANGENOTICEPERPORT_MM_H
#define _PORTS_PINCHANGENOTICEPERPORT_MM_H
...
PLIB_TEMPLATE void PORTS_PinChangeNoticePerPortEnable_MM( PORTS_MODULE_ID  index , PORTS_CHANNEL channel , PORTS_BIT_POS  bitPos )
{
    *(&CNEN0BSET + (channel - 1) * 0x40) = 1<<bitPos;
}
...
PLIB_TEMPLATE void PORTS_PinChangeNoticePerPortDisable_MM( PORTS_MODULE_ID  index , PORTS_CHANNEL channel , PORTS_BIT_POS  bitPos )
{
    *(&CNEN0BCLR + (channel - 1) * 0x40) = 1<<bitPos;
}
...
PLIB_TEMPLATE void PORTS_ChannelChangeNoticeEnable_MM( PORTS_MODULE_ID  index , PORTS_CHANNEL channel , PORTS_DATA_MASK  mask )
{
    *(&CNEN0BSET + (channel - 1) * 0x40) = mask;
}
...
PLIB_TEMPLATE void PORTS_ChannelChangeNoticeDisable_MM( PORTS_MODULE_ID  index , PORTS_CHANNEL channel , PORTS_DATA_MASK  mask )
{
    *(&CNEN0BCLR + (channel - 1) * 0x40) = mask;
}
...
PLIB_TEMPLATE bool PORTS_ExistsPinChangeNoticePerPort_MM( PORTS_MODULE_ID index )
{
    return true;
}
