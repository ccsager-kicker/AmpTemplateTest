...
#ifndef _INT_P32MM0256GPM064_H
#define _INT_P32MM0256GPM064_H
...
typedef enum {
    ...
    INT_SOURCE_EXTERNAL_1 = 4,
    INT_SOURCE_EXTERNAL_2 = 5,
    INT_SOURCE_EXTERNAL_3 = 6,
    INT_SOURCE_EXTERNAL_4 = 7,
    INT_SOURCE_CHANGE_NOTICE_A = 8,
    INT_SOURCE_CHANGE_NOTICE_B = 9,
    INT_SOURCE_CHANGE_NOTICE_C = 10,
	INT_SOURCE_CHANGE_NOTICE_D = 11,
	
    INT_SOURCE_TIMER_1 = 17,
    INT_SOURCE_TIMER_2 = 18,
    INT_SOURCE_TIMER_3 = 19,

    INT_SOURCE_COMPARATOR_1 = 23,
    INT_SOURCE_COMPARATOR_2 = 24,
	INT_SOURCE_COMPARATOR_3 = 25,
	...
	INT_SOURCE_CLC3 = 39,
	INT_SOURCE_CLC4 = 40,
    INT_SOURCE_SPI_1_ERROR = 41,
    INT_SOURCE_SPI_1_TRANSMIT = 42,
    INT_SOURCE_SPI_1_RECEIVE = 43,
    INT_SOURCE_SPI_2_ERROR = 44,
    INT_SOURCE_SPI_2_TRANSMIT = 45,
    INT_SOURCE_SPI_2_RECEIVE = 46,
	INT_SOURCE_SPI_3_ERROR = 47,
	INT_SOURCE_SPI_3_TRANSMIT = 48,
	INT_SOURCE_SPI_3_RECEIVE = 49,

    INT_SOURCE_USART_1_RECEIVE = 53,
    INT_SOURCE_USART_1_TRANSMIT = 54,
    INT_SOURCE_USART_1_ERROR = 55,
	INT_SOURCE_USART_2_RECEIVE = 56,
	INT_SOURCE_USART_2_TRANSMIT = 57,
	INT_SOURCE_USART_2_ERROR = 58,
	INT_SOURCE_USART_3_RECEIVE = 59,
	INT_SOURCE_USART_3_TRANSMIT = 60,
	INT_SOURCE_USART_3_ERROR = 61,

    INT_SOURCE_I2C_1_SLAVE = 65,
    INT_SOURCE_I2C_1_MASTER = 66,
    INT_SOURCE_I2C_1_ERROR = 67,
	INT_SOURCE_I2C_2_SLAVE = 68,
	INT_SOURCE_I2C_2_MASTER = 69,
	INT_SOURCE_I2C_2_ERROR = 70,
	INT_SOURCE_I2C_3_SLAVE = 71,
	INT_SOURCE_I2C_3_MASTER = 72,
	INT_SOURCE_I2C_3_ERROR = 73,

    INT_SOURCE_INPUT_CAPTURE_1 = 74,
    INT_SOURCE_OUTPUT_COMPARE_1 = 74,
	INT_SOURCE_CCP_TIMER_1 = 75,

	INT_SOURCE_INPUT_CAPTURE_2 = 76,
	INT_SOURCE_OUTPUT_COMPARE_2 = 76,
	INT_SOURCE_CCP_TIMER_2 = 77,
	INT_SOURCE_INPUT_CAPTURE_3 = 78,
	INT_SOURCE_OUTPUT_COMPARE_3 = 78,
	INT_SOURCE_CCP_TIMER_3 = 79,
	INT_SOURCE_INPUT_CAPTURE_4 = 80,
	INT_SOURCE_OUTPUT_COMPARE_4 = 80,
	INT_SOURCE_CCP_TIMER_4 = 81,
	INT_SOURCE_INPUT_CAPTURE_5 = 82,
	INT_SOURCE_OUTPUT_COMPARE_5 = 82,
	INT_SOURCE_CCP_TIMER_5 = 83,
	INT_SOURCE_INPUT_CAPTURE_6 = 84,
	INT_SOURCE_OUTPUT_COMPARE_6 = 84,
	INT_SOURCE_CCP_TIMER_6 = 85,
	INT_SOURCE_INPUT_CAPTURE_7 = 86,
	INT_SOURCE_OUTPUT_COMPARE_7 = 86,
	INT_SOURCE_CCP_TIMER_7 = 87,
	INT_SOURCE_INPUT_CAPTURE_8 = 88,
	INT_SOURCE_OUTPUT_COMPARE_8 = 8,
	INT_SOURCE_CCP_TIMER_8 = 89,
	INT_SOURCE_INPUT_CAPTURE_9 = 90,
	INT_SOURCE_OUTPUT_COMPARE_9 = 90,
	INT_SOURCE_CCP_TIMER_9 = 91,
	
    INT_SOURCE_DMA_0 = 98,
    INT_SOURCE_DMA_1 = 99,
    INT_SOURCE_DMA_2 = 100,
    INT_SOURCE_DMA_3 = 101,

    INT_SOURCE_FLASH_CONTROL = 94,
    INT_SOURCE_CLOCK_MONITOR = 95
...
typedef enum {
    ...
    INT_VECTOR_IC1 = _CCP1_VECTOR,
    INT_VECTOR_OC1 = _CCP1_VECTOR,
    INT_VECTOR_IC2 = _CCP2_VECTOR,
    INT_VECTOR_OC2 = _CCP2_VECTOR,
    INT_VECTOR_IC3 = _CCP3_VECTOR,
    INT_VECTOR_OC3 = _CCP3_VECTOR,
    INT_VECTOR_IC4 = _CCP4_VECTOR,
    INT_VECTOR_OC4 = _CCP4_VECTOR,
    INT_VECTOR_IC5 = _CCP5_VECTOR,
    INT_VECTOR_OC5 = _CCP5_VECTOR,
	INT_VECTOR_IC6 = _CCP6_VECTOR,
	INT_VECTOR_OC6 = _CCP6_VECTOR,
	INT_VECTOR_IC7 = _CCP7_VECTOR,
	INT_VECTOR_OC7 = _CCP7_VECTOR,
	INT_VECTOR_IC8 = _CCP8_VECTOR,
	INT_VECTOR_OC8 = _CCP8_VECTOR,
	INT_VECTOR_IC9 = _CCP9_VECTOR,
	INT_VECTOR_OC9 = _CCP9_VECTOR,
...
#include "../templates/int_SingleVectorShadowSet_MM.h"
