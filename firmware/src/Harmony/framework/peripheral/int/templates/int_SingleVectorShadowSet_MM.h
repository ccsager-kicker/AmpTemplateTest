...
#ifndef _INT_SINGLEVECTORSHADOWSET_MM_H
#define _INT_SINGLEVECTORSHADOWSET_MM_H
...
PLIB_TEMPLATE bool INT_ExistsSingleVectorShadowSet_MM( INT_MODULE_ID index )
{
    return true;
}
...
*/
PLIB_TEMPLATE void INT_SingleVectorShadowSetDisable_MM( INT_MODULE_ID index )
{
    PRISSCLR = _PRISS_SEVCSS_MASK;
}
...
*/
PLIB_TEMPLATE void INT_SingleVectorShadowSetEnable_MM( INT_MODULE_ID index )
{
    PRISSSET = _PRISS_SEVCSS_MASK;
}
