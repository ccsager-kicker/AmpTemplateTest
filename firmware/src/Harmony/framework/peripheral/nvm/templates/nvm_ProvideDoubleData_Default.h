...
#ifndef _NVM_PROVIDEDOUBLEDATA_DEFAULT_H
#define _NVM_PROVIDEDOUBLEDATA_DEFAULT_H
...
#define PLIB_NVM_ExistsProvideDoubleData PLIB_NVM_ExistsProvideQuadData
PLIB_TEMPLATE bool NVM_ExistsProvideDoubleData_Default( NVM_MODULE_ID index )
{
    return true;
}
...
PLIB_TEMPLATE void NVM_FlashProvideDoubleData_Default( NVM_MODULE_ID index , uint32_t *data )
{
   uint8_t flashData;
   
   for(flashData = 0u; flashData < 2u; flashData++)
   {
