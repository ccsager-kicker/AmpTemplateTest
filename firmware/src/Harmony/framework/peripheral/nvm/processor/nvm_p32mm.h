...
#include "../templates/nvm_ProvideDoubleData_Default.h"
...
PLIB_INLINE_API bool PLIB_NVM_ExistsProvideDoubleData(NVM_MODULE_ID index)
{
     return NVM_ExistsProvideDoubleData_Default(index);
}

PLIB_INLINE_API void PLIB_NVM_FlashProvideDoubleData(NVM_MODULE_ID index, uint32_t* data)
{
     NVM_FlashProvideDoubleData_Default(index, data);
}
